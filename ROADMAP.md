...
- ~~Stage 4 — Spin interaction: clicking the text triggers a full 3D CSS spin animation via a JS-toggled class; starburst radiates from behind text and fireworks burst across the viewport after each spin~~
...
- ~~Stage 4 — Spin + starburst + fireworks~~
